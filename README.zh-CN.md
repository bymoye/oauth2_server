...
仓库中保留了对应的工程证据：[2026-06-09 OIDF full matrix](docs/conformance/2026-06-09-oidf-full-matrix.md)。该矩阵覆盖 OIDC Basic、OIDC Config、FAPI2 Security Profile Final、FAPI2 Message Signing Final、mTLS、DPoP、`private_key_jwt` 和 client credentials 变体，并以 `0 failures`、`0 warnings` 完成。
